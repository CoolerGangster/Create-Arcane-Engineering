onEvent('item.tooltip', tooltip => {
    ...
    let toltips = [
        ...
        ['kubejs:lootbag_arcane_1', "右键打开 可以获得更多战利品"],
    ...
    tooltip.addAdvanced("sophisticatedbackpacks:backpack", (item, advanced, text) => { if (!tooltip.isShift()) { text.add(1, "§7基础: §r9§7 槽位, §r1§7 升级槽") } })
    tooltip.addAdvanced("sophisticatedbackpacks:iron_backpack", (item, advanced, text) => { if (!tooltip.isShift()) { text.add(1, "§7基础: §r45§7 槽位, §r1§7 升级槽") } })
    tooltip.addAdvanced("sophisticatedbackpacks:gold_backpack", (item, advanced, text) => { if (!tooltip.isShift()) { text.add(1, "§7基础: §r27§7 槽位, §r0§7 升级槽") } })
    tooltip.addAdvanced("sophisticatedbackpacks:diamond_backpack", (item, advanced, text) => { if (!tooltip.isShift()) { text.add(1, "§7基础: §r36§7 槽位, §r4§7 升级槽") } })
    tooltip.addAdvanced("sophisticatedbackpacks:netherite_backpack", (item, advanced, text) => { if (!tooltip.isShift()) { text.add(1, "§7基础: §r63§7 槽位, §r2§7 升级槽") } })
})

...
onEvent('block.break', event => {
   ...
   if (event.player.isCreativeMode()) {return}
    ...
    if (event.player.mainHandItem.toString().includes("gavel") && event.block.id == "minecraft:ancient_debris"){
        event.player.setStatusMessage(Text.darkRed("Thou Shall not mine Ancient Debris with a Gavel"))
        event.cancel()
    }
})

...
onEvent("recipes", event =>{
    ...
    event.smithing("sophisticatedbackpacks:gold_backpack", "sophisticatedbackpacks:backpack", "create:brass_sheet")
    event.smithing("sophisticatedbackpacks:iron_backpack", "sophisticatedbackpacks:backpack", "kubejs:radiant_coil")
    event.smithing("sophisticatedbackpacks:diamond_backpack", "sophisticatedbackpacks:backpack", "pneumaticcraft:module_expansion_card")
    event.smithing("sophisticatedbackpacks:netherite_backpack", "sophisticatedbackpacks:gold_backpack", "pneumaticcraft:printed_circuit_board")
})
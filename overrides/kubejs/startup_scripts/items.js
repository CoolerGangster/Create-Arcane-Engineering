...
onEvent('item.registry', (event) => {
  ...
  */
  ...
  event.create("lootbag_create_andesite").displayName("Engineers Toolkit").rarity(RARITY_RARE).unstackable()
  event.create("lootbag_arcane_1").displayName("Artificers Bag").rarity(RARITY_UNCOMMON).unstackable()
  event.create("lootbag_arcane_2").displayName("Artificers Epic Bag").rarity(RARITY_RARE).unstackable()
  event.create("lootbag_arcane_3").displayName("Artificers Legendary Bag").rarity(RARITY_EPIC).unstackable()
  event.create("lootbag_poggers").displayName("Reward of Patience").rarity(RARITY_EPIC).unstackable()
  event.create("lootbag_create_brass").displayName("Engineers Epic Toolkit").rarity(RARITY_EPIC).unstackable()
});
